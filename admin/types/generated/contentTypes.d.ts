...
export interface ApiMenyuMenyu extends Schema.CollectionType {
  collectionName: 'menyus';
  info: {
    singularName: 'menyu';
    pluralName: 'menyus';
    displayName: '\u041C\u0435\u043D\u044E';
  ...
  attributes: {
    ...
    image: Attribute.Media;
    descr: Attribute.RichText & Attribute.Required;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
